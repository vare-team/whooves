...
exports.run = async (client, msg, args) => {
	...
	let body = await client.userLib.request('https://www.thecolorapi.com/id?hex=' + args[0].replace('#', ''), {
		json: true,
	});

	if (!body || !body.name || !body.name.value) return client.userLib.retError(msg, 'Ошибка API.');
