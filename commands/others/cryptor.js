...
exports.run = (client, msg, args) => {
	let embed = new client.userLib.discord.MessageEmbed().setColor(client.userLib.colors.inf).setTitle("🔐 Encryptor").setFooter(msg.author.tag, msg.author.displayAvatarURL());
