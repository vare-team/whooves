...
exports.run = async (client, msg, args) => {
  ...
  let imageId = await client.userLib.request({url: `https://derpi.vlos.ru/search.json?random_image=true&filter_id=175480&q=explicit${args.length ? ',' + args.join(' ') : ''}`, json: true});
  imageId = imageId.id;
  if (!imageId) {
