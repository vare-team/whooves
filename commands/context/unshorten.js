...
export const urlFinder = new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&//=]*)/)
...
export async function run(interaction) {
	...
	const body = await client.userLib.request(`https://unshorten.me/s/${url}`, { //TODO: Axios
		json: true,
	})
