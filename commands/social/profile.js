...
exports.run = async (client, msg) => {
	...
	applyText(
		canvas,
		ctx,
		client.userLib.moment(use.createdAt, 'WWW MMM DD YYYY hh:mm:ss').format('Do MMMM, YYYYг.'),
		22,
		349,
		18,
		385
	...
	applyText(
		canvas,
		ctx,
		client.userLib.moment(joinedAt, 'WWW MMM DD YYYY hh:mm:ss').format('Do MMMM, YYYYг.'),
		22,
		423,
		18,
		385
	...
	await msg.channel.send('Фото-карточка готова!', {
		files: [{ attachment: canvas.toBuffer(), name: `profile_${use.tag}.png` }],
	});
