exports.help = {
	...
	description: "Заметки\n\`\`add [text] - добавить\nrm [ID] - удалить\`\`",
	aliases: ['nt'],
	usage: [{type: 'text', opt: 1, name: 'add/rm'},
...
exports.run = async (client, msg, args) => {
	...
	let embed = new client.userLib.discord.MessageEmbed().setAuthor('📝 Заметки').setFooter(msg.author.tag, msg.author.displayAvatarURL());
