...
exports.run = async (client, interaction) => {
	if (interaction.options.getString("причина") && interaction.options.getString("причина").length > 300) return client.userLib.retError(interaction, 'Причина не может содержать в себе более 300 символов!');
