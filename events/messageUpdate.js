module.exports = async (client, oldmsg, newmsg) => {
	...
	if (newmsg.channel.type !== 'dm' && !client.userLib.checkPerm(-1,
		newmsg.channel.type === 'dm' ? {ownerID: newmsg.author.id, member: newmsg.author}
			: {ownerID: newmsg.guild.ownerID, member: newmsg.member})) {
